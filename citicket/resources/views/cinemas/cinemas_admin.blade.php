...
<head>
    ...
    <link rel="stylesheet" href="css\cinemas_admin.css">
</head>
                        ...
                        <table class='table table-dark table-striped table-hover'>
                            ...
                            @foreach ($cinemas as $item)
                                <tr class="row_1">
                                    ...
                                    <td>
                                        <img src="storage\cinemas_images\{{ $item['cinema_image_name'] }}" alt="تصویر ندارد."
                                    ...
                                    <td>
                                        <textarea style="outline:none;
                                            ...
                                            resize:none;
                                            color:white;
                                            background-color:rgba(240, 248, 255, 0)" readonly cols="20" rows="3">{{ $item['address'] }}</textarea>
                                    </td>
                                    <td>
                                        {{ $item['id'] }}
                                    </td>
