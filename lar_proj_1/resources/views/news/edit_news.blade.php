            ...
            <div class='parent flex-column'>
                ...
                <div class="ch_3 flex-row center">
                    <div class="ch_3_1 flex-column center">
                        <div class="edit_news_panel flex-row center">
                            <div id="panel_right">
                                <form action="../update-news/{{$news->id}}" method="POST" class="form-control"
                                    enctype="multipart/form-data">
                                    @csrf
                                    <label for="news_image">
                                        برای خبر یک عکس برگزیده انتخاب کنید:
                                    </label>
                                    <input type="file" name="news_image" class="form-control" accept=".jpg,.jpeg,.png"><br>
                                    <label for="news">
                                    ...
                                    <div id="advanced_textarea">
                                        ...
                                        <div id="txt_ar_main">
                                            <textarea name="news" class="form-control" id="textarea_1"
                                                placeholder=" متن خبر ..." cols="30" rows="10"
                                                dir="rtl">{{$news->news}}</textarea>
                                        </div><br>
