...
<body class="flex-column center">
                        ...
                        <div class="add_a_cinema_panel center">
                            <div id="panel_right">
                                <form action="add-a-cinema" method="POST" class="form-control"
                                    ...
                                    <label for="city">شهر محل سینما:</label>
                            ...
                            <div class='form-control' id="panel_left">
                                ...
                                <input id="file" type="file" placeholder=" (اختیاری) تصویر سینما " name="cinema_image"
    ...
    <script src="js\fetch_cinema_records.js"></script>
</body>
